// Nano Flip Get Started - Testing sketch default install 
...
// 3) I2C scanner 
//    - Plug an I2C device into the 3.3V I2C bus, and the device addresses are scanned and printed.
// 4) Fade LED on pin 9
//    - LED + Resistor from pin 9 to GND shows LED fading in and out. Ensure a resistor is put in series!
// 5) Analog read on pin A0
//    - Reads the value on A0 pin. Insert wire between A0 and 3.3V and 1023 is printed. Insert wire between A0 and GND and 0 is printed. Use a pot to change the A0 value from 0 to 1023.
...
void setup() {
  ...
  Serial.println("    Connect other end of wire to 3.3V, Serial printout should read 1023.");
